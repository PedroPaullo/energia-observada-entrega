...
def main():
    ...
    rows=[['Tempo','Clique / mostre','Fale'],
      ...
      ['4:15-5:00','Mostrar atualização mensal na interface','“A ANEEL atualiza a base mensalmente. O processo ingere, valida e publica uma nova versão somente quando os dados estão consistentes, preservando a versão anterior em caso de falha. O resultado é uma triagem repetível, com evidência que sustenta a próxima investigação.”'],
      ['','',''],
      ['','',''],
      ['','',''],
      ['','',''],
